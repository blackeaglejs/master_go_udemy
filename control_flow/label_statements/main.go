...
loop: // label
	...
	// Note that GOTO statements are not forbidden, but are heavily discouraged because they make code
	// readability poor and make it difficutl to determine control flow.
}
